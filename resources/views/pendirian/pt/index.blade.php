...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8 lg:py-12 max-w-screen-2xl">
        ...
        <div class="text-center mb-10">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Pendirian PT</h1>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden sticky top-8">
                    ...
                    <div class="bg-gradient-to-br from-pink-50 to-red-50 p-6 text-center border-b">
                        ...
                        <p class="text-gray-400 line-through text-sm mb-1">Rp 4.000.000</p>
                        <div class="text-4xl font-extrabold text-red-600 mb-2">
                            Rp 3.499.000<span class="text-xl">,-</span>
                        </div>
                    ...
                    <!-- CTA Button -->
                    <div class="p-6">
                        <a href="{{ route('pendirian.pt.form') }}" class="block w-full bg-gradient-to-r from-blue-700 to-blue-500 hover:from-blue-600 hover:to-blue-400 text-white text-lg font-semibold py-4 px-6 rounded-xl shadow-lg hover:-translate-y-0.5 hover:shadow-xl transition-all duration-300 text-center">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Kami menyediakan layanan pendirian PT yang cepat, mudah, dan terpercaya.
